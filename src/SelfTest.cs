                ...
                player.Window.Loaded += async delegate
                {
                    try
                    {
                        ...
                        if (AudioDownloader.ToolsReady)
                        {
                            ...
                            store.Save(player.Data); Check(store.Load().ThemeName == "Olympus", "Theme selection persists across library reloads");
                            ...
                            Check(cards.Length == 6 && cards.All(b => Math.Abs(b.ActualHeight-158)<1&&Math.Abs(b.ActualWidth-118)<1) && themeScroll.HorizontalScrollBarVisibility==ScrollBarVisibility.Auto, "Theme cards retain fixed dimensions in a horizontal scroller");
