    ...
    internal static class SelfTest
    {
        ...
        public static int Run(string output)
        {
            ...
            try
            {
                ...
                var updateFixture=DigitoneUpdates.Parse("{\"tag_name\":\"v2.3.30\",\"body\":\"Test notes\",\"html_url\":\"https://github.com/ItsHazardd/Digitone/releases/tag/v2.3.30\",\"prerelease\":false}");Check(updateFixture.Version=="v2.3.30"&&DigitoneUpdates.IsNewer(updateFixture.Version,"2.2.30")&&!DigitoneUpdates.IsNewer("2.2.30","2.2.30"),"GitHub release metadata parses and compares without network access");
