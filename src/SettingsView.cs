...
namespace Digitone
{
    public sealed partial class PlayerApp
    {
        ...
        internal Window CreateSettings()
        {
            ...
            var outputs=AudioPlayback.Outputs();var outputChoice=new ComboBox{Name="AudioOutputSelector",ItemsSource=outputs,Margin=new Thickness(0,8,0,0),MinWidth=360,HorizontalAlignment=HorizontalAlignment.Left};var savedOutput=outputs.FirstOrDefault(o=>String.Equals(o.Id,Data.AudioOutputId,StringComparison.OrdinalIgnoreCase));outputChoice.SelectedItem=savedOutput??outputs.First();outputChoice.SelectionChanged+=delegate{var selected=outputChoice.SelectedItem as AudioOutputChoice;if(selected!=null)ChangeAudioOutput(selected.Id);};outputPanel.Children.Add(outputChoice);appearance.Children.Add(SettingsCard(outputPanel));
            ...
            appearance.Children.Add(SettingsCard(UpdateSettingsPanel()));
