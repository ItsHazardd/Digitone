...
namespace Digitone
{
    ...
    internal static class DigitoneUpdates
    {
        ...
        internal static string Prompt(string version){version=(version??"").TrimStart('v','V');return "Digitone "+version+" is available.\n\nDigitone will download, verify, and install it while keeping your Data and DigiMusic folders safe.\n\nInstall Digitone "+version+" now?";}
